...
3. **Install the Rust Analyzer Extension**
   ...
   - This extension contains useful features including the ability to run your code without the use of a terminal. You will find two small buttons usually above your `main()` function that can be used to run and debug the code.
